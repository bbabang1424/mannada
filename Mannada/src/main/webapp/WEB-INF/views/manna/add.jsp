	...
	<div class="container">
		...
		<div>
			<form method="post" class="box">
				...
				<div class="category">
					<label id="interval">카테고리</label> 
					<input class="Choose_start" type="radio"name="category" value="1">  공동구매 
					<input class="Choose" type="radio"name="category" value="2">  운동 
					<input class="Choose" type="radio"name="category" value="3">  게임
					<input class="Choose" type="radio"name="category" value="4">  식사
					<input class="Choose" type="radio"name="category" value="5" checked="checked">  기타
				</div>
				<div class="line"></div>

				<div class="member">
					<label id="interval">모집인원</label>
					 <input id="member" name="member" type="number"> 명
				</div>
				
				<div class="line"></div>
				
				<div class="dDay">
					<label id="interval">모집일</label> 
				...
				<div class="postnum">
					<label id="interval">주소</label> 
					<input id="postnum" name="postnum" type="text" placeholder="우편번호"> 
						<input id="road_addr" name="address" type="text" placeholder="주소">
						<input id="detAddr" name="detAddress" type="text" placeholder="상세주소">
					<input id="postnum_search" type="button"onclick="DaumPostcode()" value="찾기"> 
				</div>
				<div class="line"></div>
