...
<body>
	<div class="wrapper">
        ...
        <div class="password">
            <input id="password" type="password" name="pw" placeholder="비밀번호 (영문, 숫자 포함 최소 8자, 최대 20자 이내)">
            <div id="passwordError" class="error"></div>
        </div>
        
        <div class="passwordCheck">
            <input id="passwordCheck" type="password" name="pw_v" placeholder="비밀번호 확인">
            <div id="passwordCheckError" class="error"></div>
        </div>

        <div class="nickname">
            <input id="nickname" type="text" name="nickname" placeholder="닉네임 (공백없이 한글, 영문, 숫자만 입력 가능)">
